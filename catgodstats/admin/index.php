...
/**
 * catgodstats.thearchdaemon.org — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | CatGod — Statistics</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: CatGod — Statistics</h1>
        <p class="kicker">Protected panel for catgodstats.thearchdaemon.org</p>
