...
/**
 * dev.goldhatconsulting.com — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | Development Sandbox</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: Development Sandbox</h1>
        <p class="kicker">Protected panel for dev.goldhatconsulting.com</p>
