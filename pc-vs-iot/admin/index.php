...
/**
 * pc-vs-iot.goldhatconsulting.com — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | AI Thunderdome</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: AI Thunderdome</h1>
        <p class="kicker">Protected panel for pc-vs-iot.goldhatconsulting.com</p>
