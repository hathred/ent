...
/**
 * professional.thearchdaemon.org — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | Professional Portfolio</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: Professional Portfolio</h1>
        <p class="kicker">Protected panel for professional.thearchdaemon.org</p>
