...
/**
 * study.thearchdaemon.org — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | Study Resources</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: Study Resources</h1>
        <p class="kicker">Protected panel for study.thearchdaemon.org</p>
