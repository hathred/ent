...
<head>
  ...
  <title>Admin | ArchDaemon — Protect My Legacy</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: ArchDaemon — Protect My Legacy</h1>
        <p class="kicker">Protected panel for thearchdaemon.org</p>
