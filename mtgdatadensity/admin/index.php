...
<head>
  ...
  <title>Admin | MTG Data Density — Tensor Decomposition</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: MTG Data Density — Tensor Decomposition</h1>
        <p class="kicker">Protected panel for mtgdatadensity.thearchdaemon.org</p>
