...
/**
 * catgodclaws.thearchdaemon.org — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | CatGod — Deck Interactions</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: CatGod — Deck Interactions</h1>
        <p class="kicker">Protected panel for catgodclaws.thearchdaemon.org</p>
