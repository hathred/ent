...
/**
 * goldhatconsulting.com — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | GoldHat Consulting</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: GoldHat Consulting</h1>
        <p class="kicker">Protected panel for goldhatconsulting.com</p>
