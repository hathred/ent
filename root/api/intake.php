...
/**
 * goldhatconsulting.com — Intake API Endpoint
 * POST api/intake.php
 *
...
$stmt->execute([
    ...
    ':domain'  => 'goldhatconsulting.com',
]);

$id = (int) $pdo->lastInsertId();
Audit::log($pdo, 'intake.create', 'intake_requests', $id, ['name' => $name, 'domain' => 'goldhatconsulting.com']);
