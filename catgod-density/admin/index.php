...
/**
 * catgod-density.thearchdaemon.org — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | CatGod — Data Density</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: CatGod — Data Density</h1>
        <p class="kicker">Protected panel for catgod-density.thearchdaemon.org</p>
