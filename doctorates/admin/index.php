...
<head>
  ...
  <title>Admin | Doctorate Tracking</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: Doctorate Tracking</h1>
        <p class="kicker">Protected panel for doctorates.thearchdaemon.org</p>
