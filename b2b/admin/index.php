...
/**
 * b2b.goldhatconsulting.com — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | B2B Technology Services</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: B2B Technology Services</h1>
        <p class="kicker">Protected panel for b2b.goldhatconsulting.com</p>
