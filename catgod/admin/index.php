...
/**
 * catgod.thearchdaemon.org — Admin Panel
 * admin/index.php
 *
...
<head>
  ...
  <title>Admin | CatGod — Guenhwyvar Deck Analysis</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: CatGod — Guenhwyvar Deck Analysis</h1>
        <p class="kicker">Protected panel for catgod.thearchdaemon.org</p>
