...
<head>
  ...
  <title>Admin | Residential Tech Services</title>
...
<body>
  <div class="shell" style="grid-template-columns:1fr">
    <main class="main" id="main">
      <div class="container">
        <h1>Admin: Residential Tech Services</h1>
        <p class="kicker">Protected panel for residential.goldhatconsulting.com</p>
