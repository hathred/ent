...
/**
 * residential.goldhatconsulting.com — Intake API Endpoint
 * POST api/intake.php
 *
...
$stmt->execute([
    ...
    ':domain'  => 'residential.goldhatconsulting.com',
]);

$id = (int) $pdo->lastInsertId();
Audit::log($pdo, 'intake.create', 'intake_requests', $id, ['name' => $name, 'domain' => 'residential.goldhatconsulting.com']);
